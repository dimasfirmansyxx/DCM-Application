<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="<?= base_url() ?>assets/img/user-ava/<?= $this->Clsglobal->user_info($this->session->user_id)["profile_photo"] ?>" class="img-circle elevation-2" alt="<?= $this->Clsglobal->user_info($this->session->user_id)["nama"] ?>" style="background-color: #fff">
      </div>
      <div class="info">
